...
const fetchUserVectors_1 = require("./fetchUserVectors");
...
async function createAndSaveIndex() {
    ...
    const userVectors = await (0, fetchUserVectors_1.fetchUserVectors)();
...
function searchNearestNeighbors(queryPoint, numNeighbors = 10) {
